...
<template>
    <van-row>
        ...
        <van-col span="24" style="padding-top: 20px;">
            <van-row>
                <van-col span="6" v-for="(item, index) in list" :key="index" @click="changeroute(item.title,item.type,item.jiage)" style="text-align: center;">
